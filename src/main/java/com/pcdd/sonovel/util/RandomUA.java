...
public class RandomUA {
    ...
    private final String[] DESKTOP_OS = {
    ...
    private final int MIN_VERSION = 86; // Minimum browser version
    private final int MAX_VERSION = 145; // Maximum browser version

    private final Random RANDOM = new Random();

    public String generate() {
        String operatingSystem = DESKTOP_OS[RANDOM.nextInt(DESKTOP_OS.length)];
        ...
        return switch (browser) {
            ...
            case "Safari" ->
                    String.format("Mozilla/5.0 (%s) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/%d.1 Safari/537.36",
